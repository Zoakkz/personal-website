...
export default function Minecraft() {
  const builds = [
    {
      src: "/minecraft1.png",
      title: "Japanese Castle Complex",
      description:
        "A multi-structure Japanese castle built at sunset with a pagoda, gate, and surrounding grounds.",
    },
    {
      src: "/minecraft2.png",
      title: "Overgrown Cottage",
      description:
        "A mossy stone cottage surrounded by apple trees, wildflowers, and a cobblestone path.",
    },
  ];
  ...
  return (
    <div className="min-h-screen dark:bg-zinc-950 bg-white px-12 py-16 max-w-5xl mx-auto">
      ...
      <p className="text-zinc-400 mb-16">
        A collection of things I've built in Minecraft over the years.
      </p>
